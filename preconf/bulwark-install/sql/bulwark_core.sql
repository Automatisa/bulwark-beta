...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('179', 'panel_le_extra_sans', 'SANs extra del cert del panel', '', NULL, 'Lista separada por comas de hostnames adicionales a incluir en el certificado Let''s Encrypt del panel (p.ej. mail.<dominio>,ftp.<dominio>,mta-sts.<dominio>). Solo se añaden los que caen bajo una zona que gestiona el panel; se validan por DNS-01. El instalador la rellena según el dominio proveedor.', 'Bulwark Config', 'false');
