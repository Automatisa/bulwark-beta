...
('11','0', 'A',     'webmail', 3600,   ':IP:', NULL, NULL, NULL);
...
CREATE TABLE `x_dns_nodes` (
  ...
  `nd_ip6_vc` varchar(45) DEFAULT NULL COMMENT 'IPv6 PUBLICA del nodo (registros AAAA del DNS: ns/panel); NULL = solo IPv4',
...
INSERT INTO `x_modules` (`mo_id_pk`, `mo_category_fk`, `mo_name_vc`, `mo_version_in`, `mo_folder_vc`, `mo_type_en`, `mo_desc_tx`, `mo_installed_ts`, `mo_enabled_en`, `mo_updatever_vc`, `mo_updateurl_tx`) VALUES ('62', '6', 'Mail Server', '100', 'mailserver_admin', 'modadmin', 'Estado del servidor de correo: cola, log reciente, contadores e IPs bloqueadas (solo lectura).', '1782745660', 'true', NULL, NULL);
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES (NULL, 'daemon_hourrun', 'Daemon timeing cache', '0', NULL, 'Timestamp of when the daemon hourly cycle last ran.', NULL, 'false');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('53', 'max_mail_size', 'Max Mailbox Size', '200', NULL, 'Default mailbox size (MB) pre-filled when creating a mailbox. Users can freely choose a different size per mailbox (limited only by their package disk quota). Default = 200', 'Mail Config', 'true');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('61', 'expire_ttl', 'SOA Expire TTL', '1209600', NULL, 'Global expire TTL. Default = 86400 (1 day)', 'DNS Config', 'true');
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('62', 'minimum_ttl', 'SOA Minimum TTL', '3600', NULL, 'Global minimum TTL. Controls negative caching (RFC 2308). Default = 3600 (1 hour)', 'DNS Config', 'true');
...
INSERT INTO `x_settings` (`so_id_pk`, `so_name_vc`, `so_cleanname_vc`, `so_value_tx`, `so_defvalues_tx`, `so_desc_tx`, `so_module_vc`, `so_usereditable_en`) VALUES ('179', 'panel_le_extra_sans', 'Certificado del panel: nombres de servicio (SANs)', '', NULL, 'Lista (separada por comas) de nombres de servicio a incluir en el certificado del panel, p.ej. mail.tudominio, ftp.tudominio. Se edita en el bloque "Certificado del panel" de Bulwark Config (no en la lista genérica). El FQDN del panel y los subdominios cableados al cert (mta-sts) se añaden solos. Se siembra al instalar con el MX real; validación DNS-01; se aplica en la próxima renovación.', 'Bulwark Config', 'false');
