...
/** Reloading the settings afresh for bulwark as many have changed values or names */
...
(6,'dbversion','Bulwark version','1.0.3',NULL,'Database Version','Bulwark Config','false'),
(7,'bulwark_root','Bulwark root path','/etc/bulwark/panel/',NULL,'Bulwark Web Root','Bulwark Config','true'),
(8,'module_icons_pr','Icons per Row','10',NULL,'Set the number of icons to display before beginning a new line.','Bulwark Config','false'),
(10,'Bulwark_df','Date Format','H:i jS M Y T',NULL,'Set the date format used by modules.','Bulwark Config','true'),
(13,'servicechk_to','Service Check Timeout','10',NULL,'Service Check Timeout','Bulwark Config','true'),
(14,'root_drive','Root Drive','/',NULL,'The root drive where Bulwark is installed.','Bulwark Config','true'),
(16,'php_exer','PHP executable','php',NULL,'PHP Executable','Bulwark Config','false'),
(17,'temp_dir','Temp Directory','/var/bulwark/temp/',NULL,'Global temp directory.','Bulwark Config','true'),
...
(21,'server_ip','Server IP Address','',NULL,'If set this will use this manually entered server IP address which is the prefered method for use behind a firewall.','Bulwark Config','true'),
(22,'zip_exe','ZIP Exe','zip',NULL,'Path to the ZIP Executable','Bulwark Config','true'),
(24,'disable_hostsen','Disable auto HOSTS file entry','false','true|false','Disable Host Entries','Bulwark Config','false'),
(25,'latestzpversion','Cached version of latest bulwark version','1.0.0',NULL,'This is used for caching the latest version of Bulwark.','Bulwark Config','false'),
(26,'logmode','Debug logging mode','db','db|file|email','The default mode to log all errors in.','Bulwark Config','true'),
(27,'logfile','Bulwark Log file','/var/bulwark/logs/bulwark.log',NULL,'If logging is set to "file" mode this is the path to the log file that is to be used by Bulwark.','Bulwark Config','true'),
(28,'apikey','XMWS API Key','ee8795c8c53bfdb3b2cc595186b68912',NULL,'The secret API key for the server.','Bulwark Config','false');

INSERT  INTO zpanel_core.`x_settings`(`so_id_pk`,`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) VALUES 
(29,'email_from_address','From Address','bulwark@localhost',NULL,'The email address to appear in the From field of emails sent by Bulwark.','Bulwark Config','true'),
(30,'email_from_name','From Name','Bulwark Server',NULL,'The name to appear in the From field of emails sent by Bulwark.','Bulwark Config','true'),
(31,'email_smtp','Use SMTP','false','true|false','Use SMTP server to send emails from. (true/false)','Bulwark Config','true'),
(32,'smtp_auth','Use AUTH','false','true|false','SMTP requires authentication. (true/false)','Bulwark Config','true'),
(33,'smtp_server','SMTP Server','',NULL,'The address of the SMTP server.','Bulwark Config','true'),
(34,'smtp_port','SMTP Port','465',NULL,'The port address of the SMTP server (usually 25)','Bulwark Config','true'),
(35,'smtp_username','SMTP User','',NULL,'Username for authentication on the SMTP server.','Bulwark Config','true'),
(36,'smtp_password','SMTP Pass','',NULL,'Password for authentication on the SMTP server.','Bulwark Config','true'),
(37,'smtp_secure','SMTP Auth method','false','false|ssl|tls','If specified will attempt to use encryption to connect to the server, if "false" this is disabled. Available options: false, ssl, tls','Bulwark Config','true'),
...
(46,'ftp_db','FTP Database','bulwark_proftpd',NULL,'The name of the ftp server database','FTP Config','true'),
...
(53,'max_mail_size','Max Mailbox Size','200',NULL,'Default mailbox size (MB) pre-filled when creating a mailbox. Users can freely choose a different size per mailbox (limited only by their package disk quota). Default = 200','Mail Config','true'),
...
(63,'custom_ip','Allow Custom IP','true','true|false','Allow users to change IP settings in A records. If set to false, IP is locked to server IP setting in Bulwark Config','DNS Config','true'),
...
(75,'static_dir','Static Pages Directory','/etc/bulwark/panel/etc/static/',NULL,'The Bulwark static directory, used for storing welcome pages etc. etc.','Apache Config','true'),
...
(87,'global_zpcustom','Global Bulwark Entry',NULL,NULL,'Extra directives for Bulwark default vhost.','Apache Config','true'),
(88,'use_openbase','Use Open Base Dir','true','true|false','Enable openbase directory for all vhosts','Apache Config','true'),
(90,'bulwark_domain','Bulwark Domain','bulwark.ztest.com',NULL,'Domain that the control panel is installed under.','Bulwark Config','false'),
(91,'log_dir','Log Directory','/var/bulwark/logs/',NULL,'Root path to directory log folders','Bulwark Config','true'),
...
(99,'zsudo','zsudo path','/etc/bulwark/panel/bin/zsudo',NULL,'Path to the zsudo binary used by Apache to run system commands.','Bulwark Config','true');
...
(103,'daemon_exer',NULL,'/etc/bulwark/panel/bin/daemon.php',NULL,'Path to the Bulwark daemon','Bulwark Config','false'),
(104,'daemon_timing',NULL,'0 * * * *',NULL,'Cron time for when to run the Bulwark daemon','Bulwark Config','false'),
(105,'cron_file','Cron File','',NULL,'Path to the user cron file','Cron Config','true'),
(107,'mysqldump_exe','MySQL Dump','mysqldump',NULL,'Path to MySQL dump','Bulwark Config','false'),
...
(112,'mailer_type','Mail method','mail','mail|smtp|sendmail','Method to use when sending emails out. (mail = PHP Mail())','Bulwark Config','true'),
(113,'daemon_run_interval','Number of seconds between each daemon execution','300',NULL,'The total number of seconds between each daemon run (default 300 = 5 mins)','Bulwark Config','false'),
(114,'debug_mode','Bulwark Debug Mode','prod','dev|prod','Whether or not to show PHP debug errors,warnings and notices','Bulwark Config','true'),
(115,'password_minlength','Min Password Length','6',NULL,'Minimum length required for new passwords','Bulwark Config','true'),
...
(120,'login_csfr','Remote Login Forms','false','false|true','Disables CSFR protection on the login form to enable remote login forms.','Bulwark Config','true'),
(121,'bulwark_port','Bulwark Apache Port','80',NULL,'Bulwark Apache panel port (change will be pending until next daemon run)','Bulwark Config','true');
...
Wenn Sie einen Fehler mit Bulwark gefunden haben, können Sie ihn hier melden.' WHERE `tr_id_pk` = '98';
...
/* reset all users to new bulwark theme */
